...
$query = "
		...
		SET  
			...
			cliente_cadastrado_por= '$cliente_cadastrado_por',
...
// SITE LISTA.PHP
		print "<script> window.location='agenda.php?&id_usuario=id_usuario&grupo_usuario=$grupo_usuario&adm_usuario=$adm_usuario';</script>";
